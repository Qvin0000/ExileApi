...
namespace Exile
{
    public class CoreSettings : ISettings
    {
        ...
        [Menu("Load plugins in multithread","When you use a lot plugins that option can help hud faster start. Currently not recommend use it because can be unstable start.", 15, 0)]

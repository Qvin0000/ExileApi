...
namespace Basic.Models
{
    public sealed class ItemStats
    {
        ...
        private void ParseExplicitMods() {
            foreach (var current in item.GetComponent<Mods>().ItemMods) translate.Translate(this, current);
        ...
        public void AddToMod(ItemStatEnum stat, float value) => stats[(int) stat] += value;

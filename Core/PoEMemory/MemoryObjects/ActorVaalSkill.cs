namespace ExileCore.PoEMemory.MemoryObjects
{
    public class ActorVaalSkill : RemoteMemoryObject
    {
        ...
        public string VaalSkillSkillName => M.ReadStringU(M.Read<long>(M.Read<long>(Address + NAMES_POINTER_OFFSET) + SKILL_NAME_OFFSET));
        public string VaalSkillIcon => M.ReadStringU(M.Read<long>(M.Read<long>(Address + NAMES_POINTER_OFFSET) + ICON_OFFSET));

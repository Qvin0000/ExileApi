    ...
    public class Player : Component
    {
        ...
        private IList<PassiveSkill> AllocatedPassivesM() {
            ...
            foreach (var id in passiveIds)
            {
                ...
                if (passive == null)
                {
                    DebugWindow.LogMsg($"Can't find passive with id: {id}", 10, SharpDX.Color.Red);
                    continue;
                }
        ...
        public class TrialState
        {
            ...
            public override string ToString() => $"Completed: {IsCompleted}, Trial {TrialArea.Area.Name}, AreaId: {TrialArea.Id}";
        }
